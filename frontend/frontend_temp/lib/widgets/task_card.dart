...
class TaskCard extends StatelessWidget {
  ...
  final String? blockerTitle; // title of the task blocking this one
  ...
  Widget build(BuildContext context) {
    ...
    // AnimatedOpacity → smooth fade when task becomes unblocked
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // ── Row 2: due date + blocked-by label ───────────────────────
                Row(
                  children: [
                    ...
                    Icon(
                      ...
                      size: 13,
                      color:
                          isDue ? Colors.red.shade400 : Colors.grey.shade400,
                    ),
                    ...
                    const Spacer(),
                    // "Blocked by: <task name>" instead of just "Blocked"
